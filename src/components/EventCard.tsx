...
export default function EventCard({
    ...
    return (
        ...
        >
            {/* Image Part - Static Placeholder */}
            <div className="relative flex-1 bg-zinc-50 overflow-hidden flex items-center justify-center border-b border-zinc-100">
                {tag && (
            ...
            {/* Info Part */}
            <div className="h-20 md:h-24 bg-white p-3 md:p-5 flex flex-col justify-center gap-1 border-t border-zinc-50">
                <div className="flex justify-between items-start">
                    <div className="space-y-0.5 max-w-[80%]">
                        <h3 className="line-clamp-1 text-sm md:text-base font-black text-zinc-900">
                            {title || 'Event Name'}
                        </h3>
                        <p className="text-[9px] md:text-[11px] font-bold text-zinc-500 uppercase tracking-wider line-clamp-1">
                            {location || 'Location'}
                        </p>
                    </div>
